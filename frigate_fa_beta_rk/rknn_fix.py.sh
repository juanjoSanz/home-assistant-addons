cat <<EOF > /opt/frigate/frigate/detectors/plugins/rknn.py
import logging
import os.path
import re
...
class Rknn(DetectionApi):
    ...
    def get_soc(self):
        device_tree_content = "rockchip,rk3588-orangepi-5-plusrockchip,rk3588"
        soc = device_tree_content.split(",")[-1].strip("\x00")
        #try:
